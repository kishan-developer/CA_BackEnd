...
exports.getUserPayments = async (req, res) => {
    try {
        ...
        // Map Orders to expected frontend payment structure if needed, 
        // but typically we can handle it in the frontend thunk or here.
        // The frontend expects: _id, amount (totalAmount), status (paymentStatus), 
        // method (paymentMethod), createdAt.
